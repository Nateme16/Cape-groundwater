...
n=20                   % years
s=3                    % sources
k=.000000001                   % annual attenuation rate 
r=.01                  % discount rate
B=20983                % background/ non controllable sources
...
c(1,:)=17861.33333% yearly N input rate
c(2,:)=17861.33333
c(3,:)=17861.33333


cost_s=1000             % cost parameter for source control
cost_in=1000           % cost parameter for in-estuary control
...
[npv damage TC net] = estuaryi3(control_s,c,taum,n,k,tau,s,r,cost_s,cost_in,R,IN0,B,Target,gamma);

mnpv=@(control_s) estuaryi3(control_s,c,taum,n,k,tau,s,r,cost_s,cost_in,R,IN0,B,Target,gamma);
...
[npvop damageop TCop netop]=estuaryi3(x,c,taum,n,k,tau,s,r,cost_s,cost_in,R,IN0,B,Target,gamma);
